/// iOS [AuthService] implementation extending the shared one.
///
...
/// iOS [AuthService] that integrates Face ID / Touch ID via `local_auth`.
class IosAuthService extends SharedAuthService implements AuthService {
  /// Creates an [IosAuthService].
  IosAuthService({super.knowledgeLoader});
...
extension IosAuthServiceResultX on IosAuthService {
